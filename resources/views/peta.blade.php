<x-layout>
    ...
    <main x-data="petaDesa()" class="absolute inset-0 flex-1 z-30 bg-green-800 overflow-hidden">
        ...
        <div class="relative w-full h-full overflow-y-auto overflow-x-hidden z-10 pb-32">
            ...
            <div class="relative w-full h-[750px] z-10 mt-4 max-w-[360px] mx-auto">
